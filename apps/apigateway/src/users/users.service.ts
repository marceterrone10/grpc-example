...
import { CreateUserDto, PaginationDto, UpdateUserDto, USERS_SERVICE_NAME, type UsersServiceClient } from 'y/common';
...
export class UsersService implements OnModuleInit {
  ...
  findOne(id: string) {
    return this.usersService.findOneUser({ id: id.toString() });
  }

  update(id: string, updateUserDto: UpdateUserDto) {
    return this.usersService.updateUser({ ...updateUserDto, id: id.toString() });
  }
